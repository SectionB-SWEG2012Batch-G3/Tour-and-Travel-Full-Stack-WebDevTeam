<?php
    ...
    $sql2 = "SELECT * FROM places_to_visit INNER JOIN destination ON places_to_visit.region_id = destination.id WHERE places_to_visit.regionName = :regionName && region_id = :region_id";
...
<article>        
    ...
    <tbody>
      <?php foreach ($places as $i => $place):?>
        ...
        <td scope="row"><?php echo $place['description'];?></td>  
        ...
        <td scope="row" rowspan="2">
          ...
          <a href="addPlacesToVIsit.php?id=<?php echo $destination['id']?>" class="btn btn-sm btn-outline-primary">Add image</a>
        </td>      
        </tr>
        <tr>
      <?php endforeach;?>
