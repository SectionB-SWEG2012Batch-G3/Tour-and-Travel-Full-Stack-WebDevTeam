    ...
    <tbody>
      <?php foreach ($res as $i => $destination):?>
        ...
        <td scope="row" rowspan="2">
          <a href="viewDestination.php?id=<?php echo $destination['id']?>&active=destination" class="btn btn-sm btn-outline-primary">View</a>
          <!-- <a class="btn btn-sm btn-outline-danger">Delete</a><br/><br/> -->
          <!-- Button trigger modal -->

      
          <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $i?>">
            Delete
          </button>
          ...
          <a href="addPlacesToVIsit.php?active=destination&id=<?php echo $destination['id']?>" class="btn btn-sm btn-outline-primary">Add Places to Visit</a>
        </td>      
        </tr>
        <tr>
      <?php endforeach;?>
